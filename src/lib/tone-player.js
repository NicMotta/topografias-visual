...
import { audioState } from "./store.js";
...
const pulsoNotes = [
  null, null, "C5", null, null, "Eb5", null, null,
  "G5", null, null, "Bb5", null, null, null, null,
];
...
export async function start(item) {
...
export function stop() {
  ...
  droneSynth = pad2Synth = padAgudoSynth = textureSynth = pulsoSynth = undefined;
